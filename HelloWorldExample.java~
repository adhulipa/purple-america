...
//@WebServlet("/PurpleAmerica/index")
...
//		//
//		String filename = "data/USA-county.txt";
//		String fn = "WEB-INF/data/USA-county.txt";
//		
//		filename = fn;
//		
//		
...
//	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (request.getParameterMap().containsKey("region")) {
		...
		Purple purple = new Purple(getServletContext());
		response.setContentType("image/png");
		BufferedImage bi = purple.getImage(region, year, width, height);
